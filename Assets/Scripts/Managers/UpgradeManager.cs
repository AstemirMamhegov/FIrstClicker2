...
public class UpgradeManager : MonoBehaviour
{
    ...
    public void UpgradeX1(bool animateButton)
    {
        ...
        UpgradeAmount = CanUpradeMonyTimes(1, _currentUpgrade) ? 1 : 0;
    ...
    public void UpgradeX10(bool animateButton)
    {
        ...
        UpgradeAmount = CanUpradeMonyTimes(10, _currentUpgrade) ? 10 : 0;
    ...
    public void UpgradeX50(bool animateButton)
    {
        ...
        UpgradeAmount = CanUpradeMonyTimes(50, _currentUpgrade) ? 50 : 0;
    ...
    public void UpgradeMax(bool animateButton)
    {
        ...
        upgradeCost.text = GetUpgradeCost(UpgradeAmount, _currentUpgrade).ToString();
    }
    ...
    private void UpdatePanelValues()
    {
        ...
        float walkSpeedUpgraded = Mathf.Abs(minerMoveSpeed - (minerMoveSpeed * _currentUpgrade.CollectPerSecondMultiplier));

        // Collect Per Second
        float minerCollectPerSecond = _currentMiner.CollectPerSecond;
        float collectPerSecondUpgraded = Mathf.Abs(minerCollectPerSecond - (minerCollectPerSecond * _currentUpgrade.MoveSpeedMultiplier));
        ...
        else
        {
            ...
            // Miner stat
            stat1CurrentValue.text = (_currentUpgrade.CurrentLevel + 1) % 10 == 0 ? "+1" : "+0";
            stat2UpgradeValue.text = (_currentUpgrade.CurrentLevel + 1) % 10 == 0 ? $"+{walkSpeedUpgraded}/s" : "+0";
            stat3UpgradeValue.text = $"+{collectPerSecondUpgraded}";
