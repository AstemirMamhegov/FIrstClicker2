...
public class ElevatorMiner : BaseMiner
{
    ...
    protected override void CollectGold()
    {
        ...
        float amountToCollect = _currentShaftDeposit.CollectGold(miner: this);
        float collectTime = amountToCollect / CollectPerSecond;
        StartCoroutine(routine: IECollect(gold: amountToCollect, collectTime));
    }
    ...
    protected override void DepositGold()
    {
        ...
        StartCoroutine(routine: IEDeposit(depositTime));
    }
